...
public abstract class SubscriptionDAO implements org.schabi.newpipe.database.BasicDAO<org.schabi.newpipe.database.subscription.SubscriptionEntity> {
    ...
    @java.lang.Override()
    public abstract io.reactivex.rxjava3.core.Flowable<java.util.List<org.schabi.newpipe.database.subscription.SubscriptionEntity>> listByService(int serviceId);
    
    @org.jetbrains.annotations.NotNull()
    @androidx.room.Query(value = "SELECT * FROM subscriptions ORDER BY name COLLATE NOCASE ASC")
    @java.lang.Override()
    public abstract io.reactivex.rxjava3.core.Flowable<java.util.List<org.schabi.newpipe.database.subscription.SubscriptionEntity>> getAll();
    
    @org.jetbrains.annotations.NotNull()
    @androidx.room.Query(value = "\n        SELECT * FROM subscriptions\n\n        WHERE name LIKE \'%\' || :filter || \'%\'\n\n        ORDER BY name COLLATE NOCASE ASC\n        ")
    public abstract io.reactivex.rxjava3.core.Flowable<java.util.List<org.schabi.newpipe.database.subscription.SubscriptionEntity>> getSubscriptionsFiltered(@org.jetbrains.annotations.NotNull()
    ...
    public abstract io.reactivex.rxjava3.core.Flowable<java.util.List<org.schabi.newpipe.database.subscription.SubscriptionEntity>> getSubscriptionFlowable(int serviceId, @org.jetbrains.annotations.NotNull()
    java.lang.String url);
    
    @org.jetbrains.annotations.NotNull()
    @androidx.room.Query(value = "SELECT * FROM subscriptions WHERE url LIKE :url AND service_id = :serviceId")
    public abstract io.reactivex.rxjava3.core.Maybe<org.schabi.newpipe.database.subscription.SubscriptionEntity> getSubscription(int serviceId, @org.jetbrains.annotations.NotNull()
    java.lang.String url);
    
    @org.jetbrains.annotations.NotNull()
    @androidx.room.Query(value = "SELECT * FROM subscriptions WHERE uid = :subscriptionId")
    public abstract org.schabi.newpipe.database.subscription.SubscriptionEntity getSubscription(long subscriptionId);
    ...
    java.util.List<? extends org.schabi.newpipe.database.subscription.SubscriptionEntity> entities);
    
    @org.jetbrains.annotations.NotNull()
    @androidx.room.Transaction()
    public java.util.List<org.schabi.newpipe.database.subscription.SubscriptionEntity> upsertAll(@org.jetbrains.annotations.NotNull()
    java.util.List<? extends org.schabi.newpipe.database.subscription.SubscriptionEntity> entities) {
        return null;
    }
}