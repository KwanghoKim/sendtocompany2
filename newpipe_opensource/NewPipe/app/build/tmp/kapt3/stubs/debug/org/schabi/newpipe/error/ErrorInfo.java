...
public final class ErrorInfo implements android.os.Parcelable {
    ...
    @org.jetbrains.annotations.NotNull()
    private final org.schabi.newpipe.error.UserAction userAction = null;
    @org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.NotNull()
    public static final org.schabi.newpipe.error.ErrorInfo.Companion Companion = null;
    @org.jetbrains.annotations.NotNull()
    public static final java.lang.String SERVICE_NONE = "none";
    public static final android.os.Parcelable.Creator<org.schabi.newpipe.error.ErrorInfo> CREATOR = null;
    
    public ErrorInfo(@org.jetbrains.annotations.NotNull()
    java.lang.String[] stackTraces, @org.jetbrains.annotations.NotNull()
    org.schabi.newpipe.error.UserAction userAction, @org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.NotNull()
    public final org.schabi.newpipe.error.UserAction getUserAction() {
        return null;
    }
    ...
    private ErrorInfo(java.lang.Throwable throwable, org.schabi.newpipe.error.UserAction userAction, java.lang.String serviceName, java.lang.String request) {
        super();
    }
    
    private ErrorInfo(java.util.List<? extends java.lang.Throwable> throwable, org.schabi.newpipe.error.UserAction userAction, java.lang.String serviceName, java.lang.String request) {
        super();
    }
    ...
    public static final class Creator implements android.os.Parcelable.Creator<org.schabi.newpipe.error.ErrorInfo> {
        ...
        @org.jetbrains.annotations.NotNull()
        @java.lang.Override()
        public final org.schabi.newpipe.error.ErrorInfo createFromParcel(@org.jetbrains.annotations.NotNull()
        ...
        @org.jetbrains.annotations.NotNull()
        @java.lang.Override()
        public final org.schabi.newpipe.error.ErrorInfo[] newArray(int size) {
            return null;
        }
    }
    ...
    public static final class Companion {
        ...
        private final int getMessageStringId(java.lang.Throwable throwable, org.schabi.newpipe.error.UserAction action) {
            return 0;
        }
    }
}