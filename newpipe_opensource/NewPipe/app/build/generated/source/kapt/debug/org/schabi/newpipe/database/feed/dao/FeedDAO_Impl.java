...
public final class FeedDAO_Impl extends FeedDAO {
  ...
  @Override
  public Maybe<List<StreamWithState>> getAllStreamsForGroup(final long groupId) {
    final String _sql = "\n"
            + "        SELECT s.*, sst.progress_time\n"
            + "        FROM streams s\n"
            + "\n"
  ...
  @Override
  public Maybe<List<StreamWithState>> getLiveOrNotPlayedStreamsForGroup(final long groupId) {
    final String _sql = "\n"
            + "        SELECT s.*, sst.progress_time\n"
            + "        FROM streams s\n"
            + "\n"
