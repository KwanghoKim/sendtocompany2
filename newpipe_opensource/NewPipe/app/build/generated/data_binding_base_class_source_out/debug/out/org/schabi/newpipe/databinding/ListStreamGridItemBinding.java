...
public final class ListStreamGridItemBinding implements ViewBinding {
  ...
  private ListStreamGridItemBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ListStreamGridItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListStreamGridItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_stream_grid_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListStreamGridItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListStreamGridItemBinding((ConstraintLayout) rootView, itemAdditionalDetails,
