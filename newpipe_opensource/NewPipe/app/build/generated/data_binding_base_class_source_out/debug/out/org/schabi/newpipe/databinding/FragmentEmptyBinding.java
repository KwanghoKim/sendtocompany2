...
public final class FragmentEmptyBinding implements ViewBinding {
  ...
  private FragmentEmptyBinding(@NonNull RelativeLayout rootView,
      @NonNull ListEmptyViewBinding emptyStateView) {
  ...
  public static FragmentEmptyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentEmptyBinding((RelativeLayout) rootView, binding_emptyStateView);
    }
