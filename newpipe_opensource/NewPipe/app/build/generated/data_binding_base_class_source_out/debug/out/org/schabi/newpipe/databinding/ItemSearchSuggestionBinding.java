...
public final class ItemSearchSuggestionBinding implements ViewBinding {
  ...
  public static ItemSearchSuggestionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ImageView itemSuggestionIcon = ViewBindings.findChildViewById(rootView, id);
      if (itemSuggestionIcon == null) {
        break missingId;
      }

      id = R.id.item_suggestion_query;
      TextView itemSuggestionQuery = ViewBindings.findChildViewById(rootView, id);
      if (itemSuggestionQuery == null) {
        break missingId;
      }

      id = R.id.suggestion_insert;
      LinearLayout suggestionInsert = ViewBindings.findChildViewById(rootView, id);
      if (suggestionInsert == null) {
        break missingId;
      }

      id = R.id.suggestion_search;
      LinearLayout suggestionSearch = ViewBindings.findChildViewById(rootView, id);
