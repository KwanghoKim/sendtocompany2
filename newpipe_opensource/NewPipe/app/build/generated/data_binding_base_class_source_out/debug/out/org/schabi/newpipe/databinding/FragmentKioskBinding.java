...
public final class FragmentKioskBinding implements ViewBinding {
  ...
  private FragmentKioskBinding(@NonNull RelativeLayout rootView,
      @NonNull LinearLayout emptyStateView, @NonNull ErrorPanelBinding errorPanel,
      @NonNull NewPipeRecyclerView itemsList, @NonNull ProgressBar loadingProgressBar) {
  ...
  @NonNull
  public static FragmentKioskBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentKioskBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_kiosk, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentKioskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentKioskBinding((RelativeLayout) rootView, emptyStateView, binding_errorPanel,
          itemsList, loadingProgressBar);
    }
