...
public final class FragmentRelatedItemsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentRelatedItemsBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static FragmentRelatedItemsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentRelatedItemsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_related_items, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentRelatedItemsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRelatedItemsBinding((RelativeLayout) rootView, emptyStateView,
