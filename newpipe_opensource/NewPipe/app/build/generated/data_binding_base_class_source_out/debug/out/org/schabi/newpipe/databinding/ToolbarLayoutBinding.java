...
public final class ToolbarLayoutBinding implements ViewBinding {
  ...
  private ToolbarLayoutBinding(@NonNull LinearLayout rootView, @NonNull Toolbar toolbar,
      @NonNull ToolbarSearchLayoutBinding toolbarSearchContainer) {
  ...
  public static ToolbarLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      View toolbarSearchContainer = ViewBindings.findChildViewById(rootView, id);
      if (toolbarSearchContainer == null) {
        break missingId;
      }
      ToolbarSearchLayoutBinding binding_toolbarSearchContainer = ToolbarSearchLayoutBinding.bind(toolbarSearchContainer);

      return new ToolbarLayoutBinding((LinearLayout) rootView, toolbar,
          binding_toolbarSearchContainer);
    }
