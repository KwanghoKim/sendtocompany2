...
public final class FragmentVideoDetailBinding implements ViewBinding {
  ...
  private FragmentVideoDetailBinding(@NonNull FrameLayout rootView,
      ...
      @NonNull TextView detailControlsCrashThePlayer,
      ...
      @NonNull ImageButton overlayPlayPauseButton, @NonNull ImageButton overlayThumbnail,
      @NonNull NewPipeTextView overlayTitleTextView, @NonNull FrameLayout playerPlaceholder,
      @NonNull AnimatedProgressBar positionView, @Nullable FragmentContainerView relatedItemsLayout,
      @NonNull TabLayout tabLayout, @NonNull NewPipeTextView touchAppendDetail,
      @NonNull FrameLayout videoItemDetail, @NonNull ViewPager viewPager) {
  ...
  public static FragmentVideoDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView detailControlsCrashThePlayer = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentVideoDetailBinding((FrameLayout) rootView, appBarLayout,
          ...
          overlayThumbnail, overlayTitleTextView, playerPlaceholder, positionView,
          relatedItemsLayout, tabLayout, touchAppendDetail, videoItemDetail, viewPager);
    }
