...
public final class FragmentImportBinding implements ViewBinding {
  ...
  private FragmentImportBinding(@NonNull RelativeLayout rootView,
      @NonNull NewPipeTextView infoTextView, @NonNull Button inputButton,
      @NonNull NewPipeEditText inputText, @NonNull LinearLayout inputsPanel) {
  ...
  public static FragmentImportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      NewPipeTextView infoTextView = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.input_text;
      NewPipeEditText inputText = ViewBindings.findChildViewById(rootView, id);
      if (inputText == null) {
        break missingId;
      }

      id = R.id.inputs_panel;
      LinearLayout inputsPanel = ViewBindings.findChildViewById(rootView, id);
      if (inputsPanel == null) {
        break missingId;
      }
