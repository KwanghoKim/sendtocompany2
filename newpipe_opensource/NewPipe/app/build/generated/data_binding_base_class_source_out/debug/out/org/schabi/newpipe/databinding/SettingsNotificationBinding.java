...
public final class SettingsNotificationBinding implements ViewBinding {
  ...
  private SettingsNotificationBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull SettingsNotificationActionBinding notificationAction4,
      @NonNull NewPipeTextView textView) {
  ...
  public static SettingsNotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      View notificationAction0 = ViewBindings.findChildViewById(rootView, id);
      ...
      View notificationAction1 = ViewBindings.findChildViewById(rootView, id);
      ...
      View notificationAction2 = ViewBindings.findChildViewById(rootView, id);
      ...
      View notificationAction3 = ViewBindings.findChildViewById(rootView, id);
      ...
      View notificationAction4 = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.textView;
      NewPipeTextView textView = ViewBindings.findChildViewById(rootView, id);
      if (textView == null) {
        break missingId;
      }
